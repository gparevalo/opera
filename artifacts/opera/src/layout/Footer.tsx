...
export function Footer() {
  ...
  return (
    <footer style={{ background: "#f8f9ed", borderTop: "1px solid rgba(0,34,63,0.07)" }}>
        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-[2fr_1fr_1fr_1fr_1fr] md:gap-8 xl:gap-12">
          ...
          >
            ...
            <div className="flex items-center gap-3">
              <svg width="34" height="34" viewBox="0 0 34 34" fill="none" aria-hidden>
                <circle cx="17" cy="17" r="16" stroke="rgba(43,122,140,0.25)" strokeWidth="1" />
                <circle cx="17" cy="17" r="11" fill="rgba(43,122,140,0.05)" stroke="rgba(43,122,140,0.12)" strokeWidth="1" />
                <circle cx="17" cy="17" r="6" fill="none" stroke="rgba(43,122,140,0.22)" strokeWidth="1" />
                <circle cx="17" cy="17" r="2.5" fill="#2B7A8C" />
                <line x1="17" y1="6" x2="17" y2="11" stroke="rgba(43,122,140,0.2)" strokeWidth="0.75" />
                <line x1="17" y1="23" x2="17" y2="28" stroke="rgba(43,122,140,0.2)" strokeWidth="0.75" />
                <line x1="6" y1="17" x2="11" y2="17" stroke="rgba(43,122,140,0.2)" strokeWidth="0.75" />
                <line x1="23" y1="17" x2="28" y2="17" stroke="rgba(43,122,140,0.2)" strokeWidth="0.75" />
              </svg>
              <div>
                <p className="font-display font-bold text-[15px] tracking-tight" style={{ color: "#00223f" }}>ÓPERA</p>
                <p className="text-[9px] font-semibold uppercase tracking-[0.2em] mt-0.5" style={{ color: "#2B7A8C" }}>Surgical Center</p>
              </div>
            </div>

            {/* Tagline */}
            <p className="text-sm leading-relaxed max-w-[280px]" style={{ color: "rgba(0,34,63,0.5)" }}>
              {language === "es"
            ...
            {/* Newsletter */}
            <div>
              <p className="text-[11px] font-semibold uppercase tracking-[0.16em] mb-3" style={{ color: "rgba(0,34,63,0.35)" }}>
                {language === "es" ? "Novedades" : "Newsletter"}
              </p>
              {sent ? (
                <p className="text-sm font-medium" style={{ color: "#2B7A8C" }}>
                  {language === "es" ? "¡Gracias! Te contactaremos pronto." : "Thanks! We'll be in touch soon."}
                </p>
              ) : (
                <form onSubmit={handleSubscribe}>
                  <div className="flex items-center h-11 rounded-full overflow-hidden"
                    style={{ background: "#fff", border: "1px solid rgba(0,34,63,0.1)", boxShadow: "0 2px 8px rgba(0,34,63,0.05)" }}>
                    <input
                      type="email"
                      required
                      value={email}
                    ...
                    <button
                      ...
                      aria-label={language === "es" ? "Suscribirse" : "Subscribe"}
                    >
            ...
            <div className="flex items-center gap-2.5">
              ...
              <motion.a
                ...
                whileHover={{ scale: 1.08, color: "#25D366", boxShadow: "0 0 0 3px rgba(37,211,102,0.12)" }}
                transition={{ duration: 0.18 }}
              >
          ...
          {cols.map((col, ci) => (
            <motion.div
              key={col.title}
              initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-60px" }}
              custom={ci + 1} variants={fadeUp}
            >
              <p className="text-[12px] font-semibold mb-5" style={{ color: "#00223f" }}>
                {col.title}
              </p>
