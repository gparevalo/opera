...
export default function ContactPage() {
  ...
  function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const subject = encodeURIComponent(
      "Solicitud de información · Ópera Surgical Center",
    );
                ...
                {[
                  {
                    ...
                    sub:
                      language === "es"
                        ? "Respuesta inmediata a coordinación"
                        : "Immediate response to coordination",
                  ...
                  },
                  {
                    ...
                    sub:
                      language === "es" ? "Correo oficial" : "Official email",
                  ...
                  ({ icon: Icon, label, sub, href, external, iconColor }) => (
                    <a
                      key={label}
                      href={href}
                    ...
                    >
                      <Icon
                        className="h-6 w-6 shrink-0 mt-0.5 transition-transform duration-300 group-hover:scale-110"
                      ...
                      <ArrowRight
                        className="h-4 w-4 shrink-0 mt-0.5 transition-all duration-300 group-hover:translate-x-0.5"
                        style={{ color: "var(--op-amber-line)" }}
                        aria-hidden
                      />
                    </a>
                  ),
